...
export class JogoDaVelhaService {
   ...
   */
    ...
    /**
     * Inicializar o tabuleiro do jogo vazio para todas as 
     * posições
     * @return void 
     */
    ...
    /**
     * Retorna se a tela de fim deve ser exibido
     * 
     * @return boolean
     */
    ...
    jogar(posX: number, posY:number): void{
      ...
      /**
         * 
         * Lógica para simular jogada do computador em modo aleátorio.
         * 
         * return void
         */
      cpuJogar(): void{
    ...
    /**
     * Obtém jogada válida p vitória de um jogador
     * 
     * @param number jogador
     * @return number[]
     */
